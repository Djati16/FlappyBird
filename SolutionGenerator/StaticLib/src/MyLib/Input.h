...
typedef enum KeyCode
{
    ...
    KEYCODE_PAUSE = 72,
    KEYCODE_INSERT = 73, /**< insert on PC, help on some Mac keyboards (but does send code 73, not 117) */
    KEYCODE_HOME = 74,
    KEYCODE_PAGEUP = 75,
    KEYCODE_DELETE = 76,
    KEYCODE_END = 77,
    ...
    KEYCODE_KEYCODES = 512 /**< not a key, just marks the number of scancodes
                                 for array bounds */
} KeyCode;
